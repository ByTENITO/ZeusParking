...
class Localizacion : FragmentActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val locations = listOf(
            UbicacionDetallada(LatLng(4.57659138470627, -74.2240896601396), "Soacha", "Centro regional Soacha", 0f),
            UbicacionDetallada(LatLng(4.593701120910692, -74.16766795674489), "Perdomo", "Sede perdomo", 0f),
            UbicacionDetallada(LatLng(4.592124767752068, -74.08401575355045), "San camilo", "Sede San camilo", 0f),
            UbicacionDetallada(LatLng(4.699314309392525, -74.08915049599695), "Sede 80", "Sede 80", 0f),
            UbicacionDetallada(LatLng(4.711247338118655, -74.09691817352969), "Sede 90", "Sede 90", 0f)
        )
